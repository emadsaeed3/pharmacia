        ...
        children: [
                  ...
                  FittedBox(
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text("LOG IN", style: TextStyle(color: kPrimaryColor,fontWeight: FontWeight.bold,fontSize: 17),)
                          ],
                        ),
                      ),
                    ),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Text("Login with facebook", style: TextStyle(color: kPrimaryColor,fontWeight: FontWeight.bold,fontSize: 17),),
                      ],
                    ),
                  ),
                ),
          ...
          children: [
            Text(
              ...
              style: TextStyle(fontSize: SizeConfig.safeBlockHorizontal * 12),
            ),
            SizedBox(width: 5.0),
            GestureDetector(
              onTap: () =>  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)
